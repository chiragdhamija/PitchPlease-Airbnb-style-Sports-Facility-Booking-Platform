package com.pitchplease.authservice.controller;

import com.pitchplease.authservice.model.auth.dto.request.LoginRequest;
import com.pitchplease.authservice.model.auth.dto.request.RegisterRequest;
import com.pitchplease.authservice.model.auth.dto.request.TokenInvalidateRequest;
import com.pitchplease.authservice.model.auth.dto.request.TokenRefreshRequest;
import com.pitchplease.authservice.model.auth.dto.response.TokenResponse;
...
import com.pitchplease.authservice.service.RefreshTokenService;
import com.pitchplease.authservice.service.RegisterService;
import com.pitchplease.authservice.service.UserLoginService;
...
public class AuthController {
    ...
    public CustomResponse<Void> registerAdmin(@RequestBody @Valid final RegisterRequest registerRequest) {
        System.out.println("SKIBDI"+registerRequest.getUserName());
