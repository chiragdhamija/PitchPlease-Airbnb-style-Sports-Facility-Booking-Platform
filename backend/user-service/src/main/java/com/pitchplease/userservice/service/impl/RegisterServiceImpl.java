package com.pitchplease.userservice.service.impl;

import com.pitchplease.userservice.exception.UserAlreadyExistException;
...
import com.pitchplease.userservice.model.user.entity.UserEntity;
import com.pitchplease.userservice.model.user.mapper.RegisterRequestToUserEntityMapper;
import com.pitchplease.userservice.model.user.mapper.UserEntityToUserMapper;
import com.pitchplease.userservice.repository.UserRepository;
import com.pitchplease.userservice.service.RegisterService;
...
public class RegisterServiceImpl implements RegisterService {
    ...
    public User registerUser(RegisterRequest registerRequest) {
        ...
        System.out.println("SKIBDI saving");
        System.out.println(userEntityToBeSave.getUserName());
