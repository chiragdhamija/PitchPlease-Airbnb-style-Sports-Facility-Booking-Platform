      ...
      <div class="card-body">
        <ul class="list-group list-group-flush">
          <li class="list-group-item d-flex justify-content-between">
            <span class="fw-bold"><i class="bi bi-person-fill me-2"></i>User:</span>
          ...
          <li class="list-group-item">
            <span class="fw-bold"><i class="bi bi-box-seam me-2"></i>Add-ons:</span>
            <p class="mb-0 mt-1">${payment.addonsString}</p>
          </li>
          <li class="list-group-item d-flex justify-content-between">
